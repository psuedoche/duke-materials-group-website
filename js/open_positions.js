let open_positions = {
    "Postdoctoral Associate" : {
        description: "The group of Prof. Curtarolo at the Center for Autonomous Materials Design at Duke University, USA has open postdoctoral positions in computational materials design. The group is at the forefront of the development of automatic computational methods for the discovery of materials with technological applications.Current openings are in i. autonomous mechanical property prediction, and ii. high-throughput calculations on high-entropy ceramics. Potential candidates should send one PDF file named “PDOC-202101_Lastname_Firstname.pdf” containing: cover letter, curriculum vitae and the names, emails, and phone numbers of three (or more) references to <a href = 'mailto: jobs@materials.duke.edu'>jobs@materials.duke.edu</a>, subject line “PDOC-202101: Lastname Firstname”. Only PDF material will be considered. The location of the position is Durham, NC USA. Occasional travel to Europe is required. Starting date can be negotiated. The search will continue until the positions are filled.", 
